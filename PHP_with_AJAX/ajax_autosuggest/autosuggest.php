<?php
  ...
  // str_contains searches for the string anywhere in the data
  ...
  function search($query, $choices) {
    ...
    foreach($choices as $choice) {
      // Lowercase both strings for case-insensitive search
  ...
  // populate an array with list of names from the text file.
  // (In the real world, this data would be coming from a DB.)
